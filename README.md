...
| ChatWise App | [YuChenSSR/chatwise-claude-warm-theme](https://github.com/YuChenSSR/chatwise-claude-warm-theme) | Patcher for applying Claude Warm colors and Warp backgrounds to ChatWise |
...
- ChatWise App: `app.asar` patcher for reapplying the theme after app updates.
